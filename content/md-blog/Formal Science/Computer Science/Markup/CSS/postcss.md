...
*   **Performance:** PostCSS, written in JS, is [3 times faster](https://github.com/postcss/benchmark) than libsass, which is written in C++.
...
*   [`postcss-scss`](https://github.com/postcss/postcss-scss) to work with SCSS _(but does not compile SCSS to CSS)_.

### [](https://github.com/postcss/postcss#parsers)Parsers

*   [`postcss-safe-parser`](https://github.com/postcss/postcss-safe-parser) finds and fix CSS syntax errors.

### [](https://github.com/postcss/postcss#stringifiers)Stringifiers

*   [`midas`](https://github.com/ben-eb/midas) converts a CSS string to highlighted HTML.

## [](https://github.com/postcss/postcss#plugins)Plugins

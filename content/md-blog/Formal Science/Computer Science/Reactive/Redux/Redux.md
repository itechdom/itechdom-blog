# Concepts
### Archeticture
### one giant state for the whole app
### reducers will slice the data and return a new state everytime
### Based on what?
# Prior Art
...
### seems to convert actions into dispatch function calls
### Provider
# Thrid Party
# Resources
### https://github.com/rackt/redux
### https://github.com/xgrommx/awesome-redux
### awesome list of examples

...
class actionMain{
    ...
    constructor(){
	    ...
	    update$:request.filter((req)=>{
            ...
            input$:Rx.Observable.fromEvent(dispatcher.customEvent,'slides.input$'),
            output$:Rx.Observable.fromEvent(dispatcher.customEvent,'slides.output$')
       }
    }
}

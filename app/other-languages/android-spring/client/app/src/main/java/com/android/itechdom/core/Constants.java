...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.android.itechdom";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "com-android-itechdom";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.android.itechdom.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.android.itechdom.";

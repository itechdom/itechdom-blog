...
* com-android-itechdom is now API 15+ only.
* I will also be implementing RxJava, Material design and a few other things into this app as well.
There will be *no upgrade path* as com-android-itechdom is mean to act as a starting point for Android Applications.

# com-android-itechdom App

[![Build Status](https://travis-ci.org/AndroidBootstrap/com-android-itechdom.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-android-itechdom)

This repository contains the source code for the [com-android-itechdom](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.android.itechdom).

Please see the [issues](https://github.com.android.itechdom/com-android-itechdom/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about com-android-itechdom? Ask away on the [com-android-itechdom discussion forum](https://groups.google.com/forum/#!forum/com-android-itechdom).

<a href="https://play.google.com/store/apps/details?id=com.android.itechdom" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.android.itechdom__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.android.itechdom__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.android.itechdom.R__) will now be renamed
...
signed with a different key.  Manually uninstall com-android-itechdom from your device and
...
com-android-itechdom is a result of a template project I've developed over the years as well as
...
com-android-itechdom is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.android.itechdom/com-android-itechdom/contributors) on
...
[pull requests](https://github.com.android.itechdom/com-android-itechdom/pulls).
